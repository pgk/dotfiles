...
if [ "$color_prompt" = yes ]; then
    PS1='\[\033[01;36m\][ ${debian_chroot:+($debian_chroot)}\[\033[0m\]\u\[\033[0m\]@\[\033[0m\]\h\[\033[01;32m\] | \[\033[0m\]\w\[\033[00m\] \[\033[01;36m\]]\[\033[01;0m\]$(__git_ps1 " (%s)") \[\033[36m\]\$ \[\033[0m\]'
else
...
if [ "$MYOS" = "darwin" ] && [ -f /usr/local/etc/bash_completion ]; then
