...
local function update_panel()
  ...
  -- Apply highlights
  local ns = vim.api.nvim_create_namespace("ariadne_links")
...
function M.create()
  ...
  vim.api.nvim_buf_set_name(M.state.buf, "AriadneLinks")
  ...
  vim.api.nvim_buf_set_option(M.state.buf, "filetype", "AriadneLinks")
...
function M.setup()
  vim.api.nvim_create_user_command("AriadneLinksPanel", function()
    M.toggle()
  end, { desc = "Toggle the Ariadne links panel" })
end
