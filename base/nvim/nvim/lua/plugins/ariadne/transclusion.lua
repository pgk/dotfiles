-- Transclusion support for the Ariadne notes workflow
...
local function setup_highlights()
  vim.api.nvim_set_hl(0, "AriadneTransclusionBorder", { fg = "#565f89", italic = true })
  vim.api.nvim_set_hl(0, "AriadneTransclusionContent", { fg = "#9aa5ce", italic = true })
  vim.api.nvim_set_hl(0, "AriadneTransclusionHeader", { fg = "#7aa2f7", bold = true, italic = true })
  vim.api.nvim_set_hl(0, "AriadneTransclusionBold", { fg = "#c0caf5", bold = true, italic = true })
  vim.api.nvim_set_hl(0, "AriadneTransclusionList", { fg = "#9ece6a", italic = true })
  vim.api.nvim_set_hl(0, "AriadneTransclusionLink", { fg = "#7dcfff", italic = true, underline = true })
end
  ...
  for i, line in ipairs(lines) do
    ...
    if note_name then
      ...
      if content and #content > 0 then
        ...
        -- Bottom border
        table.insert(virt_lines, { { "  └" .. string.rep("─", 40), "AriadneTransclusionBorder" } })
...
function M.setup()
  ...
  vim.api.nvim_create_user_command("AriadneTransclusionToggle", function()
    M.toggle()
  end, { desc = "Toggle transclusion rendering" })

  vim.api.nvim_create_user_command("AriadneTransclusionDebug", function()
    M.debug()
